...
VALUES
  ('00000000-0000-0000-0000-000000000001', 'Admin User', 'admin@example.com', 'Pocket HR', 'Administrator', 'premium', 'cus_premium1', 'sub_premium1', 'active', true, true, false, true, 3, NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000002', 'Jane Smith', 'user1@example.com', 'Acme Corp', 'HR Manager', 'premium', 'cus_premium2', 'sub_premium2', 'active', true, true, true, true, 2, NOW(), NOW()),
  ('00000000-0000-0000-0000-000000000003', 'John Doe', 'user2@example.com', 'XYZ Inc', 'Software Developer', 'basic', NULL, NULL, NULL, true, false, false, true, 0, NOW(), NOW())
ON CONFLICT (id) DO NOTHING;
