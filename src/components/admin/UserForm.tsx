  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        <FormField
          control={form.control}
          name="wordCredits.total"
          render={({ field }) => (
            <FormItem>
              <FormLabel>Total Word Credits</FormLabel>
              <FormControl>
                <Input
                  type="number"
                  min="0"
              ...
              <FormDescription>
                The total number of word credits allocated to this user.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          control={form.control}
          name="wordCredits.remaining"
          render={({ field }) => (
            <FormItem>
              <FormLabel>Remaining Word Credits</FormLabel>
              <FormControl>
                <Input
                  type="number"
                  min="0"
              ...
              <FormDescription>
                The remaining word credits available to this user.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
